            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-12">
                    <div className="lg:w-1/2">
                        <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white mb-4">About Stellar Solutions</h2>
                    ...
                    <div className="lg:w-1/2">
                        <div className="grid grid-cols-2 gap-8">
                            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg text-center shadow-md">
                                <span className="text-4xl font-bold text-blue-500">10+</span>
                                <p className="text-gray-600 dark:text-gray-300 mt-2">Years of Experience</p>
                            </div>
                            <div className="bg-white dark:bg-gray-700 p-6 rounded-lg text-center shadow-md">
                             ...
                             <div className="bg-white dark:bg-gray-700 p-6 rounded-lg text-center shadow-md">
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mt-2">Expert Engineers</p>
                            </div>
                        </div>
                    </div>
                </div>
